...
//     } catch(err){
//         console.log(err)
//         return res.status(400).send('Product delete fail')
//     }
// }
exports.remove = async (req, res) => {
    try {
  ...
  //   //check if currentlly logged in user have already added rating this product? 
  ...
  //   }else{
  //     // if user already left rating yet, update it
...
const handleStar =  (req, res,stars) => {
    Product.aggregate([
      { 
        $project: { 
          document: "$$ROOT", // lấy tất cả element trong product
          floorAverage: { //làm tròn cho chuẩn 3,33 => 3
